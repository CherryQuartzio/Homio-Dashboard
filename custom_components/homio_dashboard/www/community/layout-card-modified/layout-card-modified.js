                ...
                var n = function(t) {
                    for (var n = 0, i = Object.entries(t); n < i.length; n++) {
                        var r = P(i[n], 2),
                            o = r[0],
                            a = r[1];
                        (o.startsWith("grid") || o.startsWith("scroll") || "grid" === o || "place-items" === o || "place-content" === o || "align-items" === o || "justify-items" === o || "width"=== o|| "inset" === o || "position" === o|| "background" === o|| "padding" === o|| "backdrop-filter" === o || "display" === o || "height" === o || "margin" === o || "overflow" === o || "overflow-x" === o || "overflow-y" === o || "box-sizing" === o) && e.style.setProperty(o, a)
                    }
                };
